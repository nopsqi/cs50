...
JOIN people p1 ON p1.phone_number = pc.receiver OR p1.phone_number = pc.caller
JOIN passengers pas ON (pas.passport_number = p1.passport_number OR pas.passport_number = p.passport_number) AND p1.name != p.name
